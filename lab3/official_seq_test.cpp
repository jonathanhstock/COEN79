    ...
    do
    {
        ...
        switch (choice)
        {
			...
			case 'F': test.insert_front(get_number( ));
					  break;
			case 'X': test.remove_front( );
					  cout << "The item at the front has been removed." << endl;
					  break;
			case 'D': cout << "The standard deviation is " << test.standardDeviation( ) << "." << 					   			endl;
					  break;
			case 'E': test2.insert(get_number( ));
					  break;
			case 'O': show_sequence(test+test2);
					  break;
			case 'U': cout << "The sum of test is " << summation(test) << "." << endl;
					  break;
...
// Library facilities used: iostream.h
{
	...
	cout << " 0   Activate the last( ) function" << endl;
	cout << " -   Activate the retreat( ) function" << endl;
    ...
    cout << " F	  Insert a new number to the front with the insert_front(...) function" <<endl;
	cout << " X   Activate the remove_front( ) function" << endl;
	cout << " D   Print out the standard deviation" << endl;
	cout << " E   Insert a new number into test2" << endl;
	cout << " O   Perform operator+ on test1 and test2" << endl;
	cout << " U   Print the sum of the sequence" << endl;
