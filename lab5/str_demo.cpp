...
{
    char x[10] = " joey ";
    const string BLANK('h');
    string me_first("Demo"), me_last("Program");
    string you_first, you_last, you, insert;
    
    char c = 'c';

    cout << "What is your first name? ";
    cin >> you_first;
  //  cout << you_first.length() << endl;
    //cout << "insert: ";
   // cin >> insert;
   // cout << endl << you_first.count(c) << endl;
  //  cout << you_first << endl << "length: " << you_first.length() << endl;
    //you_first = insert;
  //  cout << you_first << endl << "length: " << you_first.length() << endl;
